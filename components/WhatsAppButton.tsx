...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 flex items-center gap-2.5 rounded-full bg-[#25D366] py-3 pl-3.5 pr-3.5 text-white shadow-[0_10px_30px_-6px_rgba(37,211,102,0.6)] transition-all duration-500 ease-out hover:-translate-y-0.5 hover:brightness-105 sm:bottom-7 sm:right-7"
    >
